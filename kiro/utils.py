...
def get_kiro_headers(auth_manager: "KiroAuthManager", token: str) -> dict:
    ...
    return {
        ...
        "User-Agent": f"aws-sdk-js/1.0.27 ua/2.1 os/win32#10.0.19044 lang/js md/nodejs#22.21.1 api/codewhispererstreaming#1.0.27 m/E KiroIDE-1.0.337-{fingerprint}",
        "x-amz-user-agent": f"aws-sdk-js/1.0.27 KiroIDE-1.0.337-{fingerprint}",
